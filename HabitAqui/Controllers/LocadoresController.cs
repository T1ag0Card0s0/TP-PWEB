    ...
    public class LocadoresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Locador != null ? 
                          View(await _context.Locador.ToListAsync()) :
        ...
        public async Task<IActionResult> Create([Bind("LocadorId,Nome,Contacto")] Locador locador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocadorId,Nome,Contacto")] Locador locador)
        {
        ...
        {
          return (_context.Locador?.Any(e => e.LocadorId == id)).GetValueOrDefault();
        }
    }
}
