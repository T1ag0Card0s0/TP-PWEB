...
namespace HabitAqui.Controllers
{
    public class GestoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Email,Password")] Gestor gestor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,Password")] Gestor gestor)
        {
            if (id != gestor.Id)
            {
                return NotFound();
