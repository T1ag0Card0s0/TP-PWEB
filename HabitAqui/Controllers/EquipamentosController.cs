    ...
    public class EquipamentosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Equipamentos != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Equipamentos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,EquipamentoEstado,Existencia")] Equipamento equipamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,EquipamentoEstado,Existencia")] Equipamento equipamento)
        {
